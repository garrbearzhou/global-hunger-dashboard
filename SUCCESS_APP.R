# SUCCESS VERSION - This will definitely work!
# Global Hunger Research Website - Guaranteed Working Version
  ...
  output$risk_plot <- renderPlotly({
    ...
    plot_ly(risk_counts, x = ~hunger_risk, y = ~n, type = "bar",
      ...
      layout(
        ...
        annotations = list(
          x = 0.5, y = 1.1,
          text = "This chart shows how countries are distributed across different hunger risk levels based on poverty rates. Hover over bars to see exact counts and percentages.",
          showarrow = FALSE,
  ...
  output$gdp_poverty_plot <- renderPlotly({
    plot_ly(filtered_data(), 
      ...
      layout(
        ...
        annotations = list(
          x = 0.5, y = 1.1,
          text = "This scatter plot shows the relationship between economic development (GDP per capita) and poverty rates. Countries with higher GDP typically have lower poverty rates. Hover over points to see country details.",
          showarrow = FALSE,
          xref = "paper", yref = "paper",
          font = list(size = 12, color = "#666666")
        )
  ...
  output$life_expectancy_plot <- renderPlotly({
    plot_ly(filtered_data(), 
      ...
      layout(
        ...
        annotations = list(
          x = 0.5, y = 1.1,
          text = "This box plot shows how life expectancy varies across different hunger risk levels. Higher hunger risk is associated with lower life expectancy. Hover over boxes to see statistical details.",
          showarrow = FALSE,
          xref = "paper", yref = "paper",
          font = list(size = 12, color = "#666666")
        )
  ...
  output$agriculture_plot <- renderPlotly({
    plot_ly(filtered_data(), 
      ...
      layout(
        ...
        annotations = list(
          x = 0.5, y = 1.1,
          text = "This scatter plot explores the relationship between agricultural land use and poverty rates. Countries with more agricultural land may have different poverty patterns. Hover over points to see country details.",
          showarrow = FALSE,
          xref = "paper", yref = "paper",
          font = list(size = 12, color = "#666666")
        )
    ...
    if("All" %in% input$countries) {
      ...
      p <- plot_ly(global_data, x = ~year, y = ~variable_value, 
        ...
        layout(
          ...
          annotations = list(
            x = 0.5, y = 1.1,
            text = "This chart shows the global average trend over time. It helps identify whether the selected indicator is improving or worsening worldwide. Hover over points to see exact values.",
            showarrow = FALSE,
            xref = "paper", yref = "paper",
            font = list(size = 12, color = "#666666")
          )
      ...
      p <- plot_ly(country_data, x = ~year, y = ~get(input$variable),
        ...
        layout(
          ...
          annotations = list(
            x = 0.5, y = 1.1,
            text = "This chart compares trends across selected countries. Each line represents a different country, allowing you to see which countries are improving or declining. Hover over points to see country-specific values.",
            showarrow = FALSE,
            xref = "paper", yref = "paper",
            font = list(size = 12, color = "#666666")
          )
  ...
  output$world_map <- renderPlotly({
    ...
    plot_ly(
      ...
      layout(
        ...
        annotations = list(
          x = 0.5, y = 1.1,
          text = "This interactive world map shows hunger risk levels by country. Hover over any country to see detailed information including food insecurity data, GDP, population, and historical hunger outbreaks.",
          showarrow = FALSE,
          xref = "paper", yref = "paper",
          font = list(size = 12, color = "#666666")
        )
