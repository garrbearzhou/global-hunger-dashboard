...
cat("FAO processed:", nrow(fao_processed), "countries\n")
...
cat("World Bank processed:", nrow(wb_summary), "countries\n")
...
cat("PIP processed:", nrow(pip_summary), "countries\n")
...
cat("WFP processed:", nrow(wfp_data$markets), "countries\n")
...
cat("Data combination complete:", nrow(combined_data), "countries\n")
...
cat("Sovereign countries:", nrow(sovereign_countries), "\n")
cat("App ready to start!\n")

ui <- fluidPage(
  titlePanel("Global Hunger Vulnerability Analysis - Full Featured"),
