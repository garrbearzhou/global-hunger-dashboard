# Water withdrawals per capita - Data package

This data package contains the data that powers the chart ["Water withdrawals per capita"](https://ourworldindata.org/grapher/water-withdrawals-per-capita?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 28, 2025.
...
#### Full citation
Water withdrawals and consumption - Aquastat – processed by Our World in Data. “Total water withdrawal per capita” [dataset]. Water withdrawals and consumption - Aquastat [original data].
