...
This data package contains the data that powers the chart ["Freshwater withdrawals per kilogram of food product"](https://ourworldindata.org/grapher/water-withdrawals-per-kg-poore?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 28, 2025.
