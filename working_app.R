# Working version of the hunger research website
...
collect_and_prepare_data <- function() {
...
if(file.exists("data/raw/world_bank_data.csv")) {
  ...
  wb_data <- collect_and_prepare_data()
}
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("risk_level", "Hunger Risk Level:", 
                 ...
                 selected = "All"),
      br(),
      h4("📊 Key Statistics", style = "color: #2c3e50;"),
      verbatimTextOutput("stats_summary"),
      br(),
      h4("ℹ️ About", style = "color: #2c3e50;"),
    ...
    mainPanel(
      ...
      tabsetPanel(
        tabPanel("📊 Overview",
          ...
          fluidRow(
            column(6,
              h4("Life Expectancy vs Hunger Risk"),
              plotlyOutput("life_expectancy_plot", height = "350px")
            ),
            column(6,
              h4("Agricultural Land vs Hunger Risk"),
