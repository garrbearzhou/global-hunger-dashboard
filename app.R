...
body <- dashboardBody(
  ...
  tags$head(
    ...
    tags$meta(property = "og:image", content = "https://globalhungerdashboard.com/assets/og-social-preview.png?v=8"),
    ...
    tags$meta(name = "twitter:image", content = "https://globalhungerdashboard.com/assets/og-social-preview.png?v=8"),
    tags$script(HTML("
      (function() {
        const SEO_BY_TAB = {
          introduction: {
